...
//     */
//    public boolean isAvailable(Position newPos, PlayerCharacter currentPlayer) {
...
//            return false;
//        } else return map.isEmpty(newPos);
//    }
//
//
//    /**
...
//        return false;
//    }
//    public boolean hasEnemy (List<GameEntity> entities ) {
//        for (GameEntity entity : entities) {
//            for (Enemy enemy : enemies) {
//                if (enemy.equals(entity)) return true;
//            }
//        }
//        return false;
//    }
//    public boolean hasItem (List<GameEntity> entities ) {
//        for (GameEntity entity : entities) {
//            for (GameItem item : items) {
//                if (entity.equals(item)) return true;
//            }
//        }
//        return false;
//    }
//    public void fightEnemyAt (List <GameEntity> entities) {
//            Enemy enemy = findEnemy(entities);
//            if (enemy != null){
//                CombatSystem combatSystem = new CombatSystem();
//                combatSystem.resolveCombat(getCurrentPlayer(), enemy);
//                if (getCurrentPlayer().isDead()) {
//                    map.removeFromGrid(getCurrentPlayer().getPosition(), getCurrentPlayer());
//                    players.remove(getCurrentPlayer());
//                } else if (enemy.isDead()) {
//                    Treasure replacement = enemy.defeat();
//                    map.removeFromGrid(enemy.getPosition(),enemy);
//                    enemies.remove(enemy);
//                    items.add(replacement);
//                    map.addToGrid(replacement.getPosition(), replacement);
//                }
...
//
//    }
//    public void pickUpItem (Position position, List<GameEntity> entities ) {
//        GameItem item = findItem(entities);
//        if (item instanceof Interactable item2) {
//            item2.collect(getCurrentPlayer());
//            if (map.removeFromGrid(position, item)) {
//                items.remove(item);
//            }
//        }
//    }
...
//     */
//    public Enemy findEnemy(List <GameEntity> entities) {
//        for (GameEntity entity : entities) {
//            for (Enemy enemy : enemies) {
...
//        return null;
//    }
//    private GameItem findItem(List<GameEntity> entities ) {
//        for (GameEntity entity : entities) {
//            for (GameItem item : items) {
...
//     */
//    public void isVisible(PlayerCharacter currentPlayer) {
